...
Check your code: https://judge.softuni.bg/Contests/Practice/Index/1494#1
...
They’ve decided to make profit by buying items on discount from the Thrift Shop and selling them for a higher price.
You must help them.
...
you have to reduce the budget with the value of its price. If you don’t have enough money for it, you can’t buy it.
...
for item in items.split("|"):
    ...
    type_item, price = item[0], float(item[1])
