"""
********** This task is too long for me to solve now. I'll give it a try 'another time' :D
"""
...
size = int(input())
matrix = Matrix(rows=size, type_data=str)
min_number_of_knights_to_remove = 0
current_removed_knights = 0
directions = {1: [-1, -2], 2: [+1, -2], 3: [-2, -1], 4: [+2, -1], 5: [-2, +1], 6: [+2, +1], 7: [-1, +2], 8: [+1, +2]}
knights = matrix.find_coordinates_of_objects("K")
